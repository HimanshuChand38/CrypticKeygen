...
export default function PasswordGenerator() {
  ...
  return (
    <>
      <h1 className=" mt-20 text-4xl font-roboto text-center text-white">
      CrypticKeygen
      </h1>
          {/*=========== ANIMATED MESSAGE PART STARTS==================*/}
      <Animator/>
          {/*=========== ANIMATED MESSAGE PART ENDS==================*/}
      <div className="bg-slate-800 rounded-3xl w-[80%] mx-auto mt-20 mb-20 overflow-auto md:w-[50%] md:mt-10">
